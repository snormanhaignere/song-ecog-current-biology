% Load/plot component responses (Figs 2A, 5A)

% path to the downloaded repository
repo_directory = fileparts(fileparts(which('ecog_component_responses.m')));
...
% select the song selective component
c = 11;
X = R(:,:,c);
